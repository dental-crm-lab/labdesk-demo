// Отдельная супер-админ панель для LabDesk: не связана с обычным входом
...
// системах "Пульта клиник". У LabDesk нет ни таблицы запросов, ни готовой
...
// пациенты: LabDesk работает с зубными техниками и врачами, которые
